    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div className="bg-white mx-10 rounded-lg p-6 shadow-lg sm:w-1/3 ">
        ...
        <div className="flex gap-4 mb-4 items-center justify-center">
          <p className="font-semibold text-gray-950">{getWorkMode(jobDetailsWorMode)}</p>
          <span className="flex justify-center items-center text-gray-950 text-2xl"> - </span>
          <div className="flex gap-1">
            <svg
              ...
              className="icon icon-tabler icons-tabler-outline icon-tabler-map-pin text-gray-950"
            >
              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
              <path d="M9 11a3 3 0 1 0 6 0a3 3 0 0 0 -6 0" />
              <path d="M17.657 16.657l-4.243 4.243a2 2 0 0 1 -2.827 0l-4.244 -4.243a8 8 0 1 1 11.314 0z" />
            </svg>
            <p className="text-gray-950">{jobDetailsLocations.map((location: Location) => location.name)}</p>
          </div>
        </div>
